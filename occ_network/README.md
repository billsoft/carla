...
│       └─────┘                                                   │
│                                                                 │
│  形状: [1, 8, 1, 960, 1280]      形状: [1, 18, 512, 512, 40]   │
│        ↑  ↑  ↑   ↑     ↑              ↑  ↑   ↑    ↑    ↑      │
...
| 相机数量 | 8 | 特斯拉风格的环视相机布局 |
| 输出体素 | 512×512×40 | 约1000万个3D小方块 |
| 体素分辨率 | 0.2米 | 每个小方块代表20厘米×20厘米×20厘米的空间 |
| 感知范围 | 102.4m × 102.4m × 8m | 前后左右各51.2米，高度8米 |
...
flowchart TB
    ...
    subgraph EXPAND["📦 3D扩展"]
        HEIGHT["高度扩展<br/>[1, 192, 128, 128, 10]"]
        UP["上采样<br/>[1, 96, 512, 512, 40]"]
    end
    
    subgraph HEAD["🎯 输出头"]
        SEM["语义预测<br/>[1, 18, 512, 512, 40]"]
        FLOW["流场预测<br/>[1, 3, 512, 512, 40]"]
    end
...
| **高度扩展** | [1, 192, 128, 128] | [1, 192, 128, 128, 10] | 2D→3D |
| **上采样** | [1, 192, 128, 128, 10] | [1, 96, 512, 512, 40] | 放大4倍 |
| **语义头** | [1, 96, 512, 512, 40] | [1, 18, 512, 512, 40] | 分类预测 |
| **流场头** | [1, 96, 512, 512, 40] | [1, 3, 512, 512, 40] | 运动预测 |
...
flowchart TB
    ...
    subgraph UP["上采样"]
        U["Trilinear Interpolate<br/>[1, 96, 512, 512, 40]"]
    end
    
    subgraph HEAD["由粗到细输出头"]
        direction TB
        subgraph COARSE["粗糙预测"]
            CO["下采样到<br/>[1, 96, 128, 128, 10]"]
            CP["粗糙语义<br/>[1, 18, 128, 128, 10]"]
        end
        
        subgraph FINE["精细预测"]
            FI["粗糙预测上采样<br/>+ 原始特征"]
            FP["精细语义<br/>[1, 18, 512, 512, 40]"]
        end
...
**为什么？** 直接预测 512×512×40 ≈ 1000万个体素太耗显存！
...
```
粗糙预测 (128×128×10)            精细预测 (512×512×40)
┌────────────────────┐           ┌────────────────────┐
│▓▓░░░░░░░░░░░░░░░░ │           │████░░░░░░░░░░░░░░░│
│▓▓░░░░░░░░░░░░░░░░ │  只细化   │████░░░░░░░░░░░░░░░│
│░░░░░░▓▓░░░░░░░░░░ │  有物体   │░░░░░░████░░░░░░░░░│
...
# FPS: 21.9
# Output Shape: torch.Size([1, 18, 512, 512, 40])
# ==================================================
