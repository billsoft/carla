...
def main():
    ...
    print("     ✅ 优化8: 位置编码优化 (CameraRoPE 移除)")
    print("        - 移除冗余的 CameraRoPE (仅编码 Yaw)")
    print("        - 保留 RayDirectionEncoding (完整 6-DoF 几何)")
    print("        - 保留 HyperbolicFOVEncoding (FOV 差异编码)")
    print("        - 详见: occ_network/位置编码优化方案.md")
    print()
    print("  🎯 下一步建议:")
