...
4. [数据采集与训练](#数据采集)
5. [实时推理与可视化](#实时推理)
   - **5.5 时空记忆实时更新** ⭐ (详见 [时空记忆系统文档](./Occupancy-Network时空记忆系统-原理与实现.md))
6. [性能优化](#性能优化)
7. [故障排查](#故障排查)
...
**时空记忆系统** ⭐ (详见 [时空记忆系统文档](./Occupancy-Network时空记忆系统-原理与实现.md)):
- **时间记忆**: 3秒短期运动追踪 (ConvGRU3D)
- **空间记忆**: 50米半径场景存储 (Memory Bank)
- **关键特性**:
  - ✅ 解决遮挡问题 (记住被遮挡物体)
  - ✅ 解决红绿灯等待 (静止场景不衰减)
  - ✅ 轨迹预测 (基于历史运动)
