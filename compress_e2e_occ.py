#!/usr/bin/env python3
"""
代码压缩脚本 - 专用于压缩 e2e_occ 目录供 AI 分析
忽略 Markdown 文件 (.md)

用法:
    python compress_e2e_occ.py
"""
...
def main():
    parser = argparse.ArgumentParser(description='压缩 e2e_occ 代码用于 AI 分析')
    parser.add_argument('--dir', default='e2e_occ',
                       help='要分析的目录 (默认: e2e_occ)')
    parser.add_argument('--output', default='e2e_occ_code_summary.txt',
                       help='输出文件名 (默认: e2e_occ_code_summary.txt)')
