...
PathLossModel::PathLossModel(URandomEngine *random_engine, AActor *InOwner)
{
                              ...
                              const float InCustomFadingStddev)
{
    ...
    this->path_loss_exponent = InPathLossExponent;
    this->reference_distance_fspl = InReferenceDistanceFspl;
    this->filter_distance = InFilterDistance;
    this->use_etsi_fading = InUseEtsiFading;
    this->custom_fading_stddev = InCustomFadingStddev;
    this->combined_antenna_gain = InCombinedAntennaGain;
    this->Frequency_GHz = InFrequency;
...
void PathLossModel::SetScenario(EScenario InScenario)
{
...
{
    // InCurrentActorLocation in cm original
    // TxHeight in m
    // RxHeight in m
    // reference_z in cm
